...
<body>
    ...
    <div class="boxFormPedMan">
        ...
        <form class="formPedidoManutencao" id="ped_prof">
            <fieldset class="fieldsetPM reclamante">
                ...
                <div class="rowInputs">
                    <input class="inputPM tp1" type="text" name="cpf" id="cpf" oninput="mascara(this)" placeholder="CPF" required>
                    <input class="inputPM" type="text" name="curso" id="curso" placeholder="Curso" required>
                </div>
            </fieldset>
            <fieldset class="fieldsetPM espPedido">
                ...
                <input type="hidden" name="data" value="<?php $hoje = date('d/m/Y'); echo $hoje;?>">
    ...
    <script type="text/javascript">
        ...
        const formCad = document.getElementById('ped_prof');
        ...
        if(formCad){
            formCad.addEventListener("submit",async (e) =>{
                ...
                const dados = await fetch("http://localhost:8000/pedido/prof",{
                    method: "POST",
                    body: dadosForm
                });
                ...
                if(resposta['status']){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            location.reload('formPedManutencao-prof.php');
                         }else{
                              location.reload('formPedManutencao-prof.php');           
                         }
                      })
